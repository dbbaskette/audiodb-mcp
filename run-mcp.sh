...
echo "   Discography:      curl \"http://localhost:$SERVER_PORT/test/discography?artist=coldplay\""
echo "   Help:             curl \"http://localhost:$SERVER_PORT/test/help\""
echo ""
echo -e "${BLUE}📚 Available MCP Tools:${NC}"
echo "   • search_artist           - Search for musical artists"
echo "   • get_artist_discography  - Get artist's complete discography"
echo ""
